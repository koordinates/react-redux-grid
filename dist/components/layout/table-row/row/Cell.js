...
var Cell = exports.Cell = function Cell(_ref) {
    ...
    var isEditable = editorState && editorState.get && editorState.get(rowId) && editorState.get(rowId).key === rowId || editor && editor.config && editor.config.type === editor.editModes.grid;
